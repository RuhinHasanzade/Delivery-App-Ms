...
public class FoodsController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResultDto<FoodDto>> update(@PathVariable Long id,
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResultDto<FoodDto>> patchAvailability(@PathVariable Long id,
                                                                @RequestBody FoodAvailabilityRequest request) {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResultDto<Void>> delete(@PathVariable Long id) {
        foodService.delete(id);
        return ResponseEntity.ok(ResultDto.ok("Operation completed successfully", null));
    }
